...
#[checks(admin_role)]
#[usage = "sub_command"]
#[sub_commands(training_add)]
#[num_args(1)]
pub async fn training(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
    Ok(())
}
...
#[min_args(2)]
pub async fn training_add(ctx: &Context, msg: &Message, mut args: Args) -> CommandResult {
